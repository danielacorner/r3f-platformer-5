import {
  ...
  GiIceBolt,
  GiSnowflake1,
  GiFrozenRing, // Frost - Passive
  GiMissileSwarm,
  GiEnergyShield,
  GiShieldBash, // Arcane - Active
  GiLightningStorm,
  GiLightningHelix,
  GiFocusedLightning, // Storm - Active
  GiWaterSplash,
  GiHighTide,
  GiVortex, // Water - Active
  GiBoomerang,
  GiPunchBlast,
  GiVacuumCleaner, // Force - Active
  GiIceSpellCast,
  GiIciclesAura,
  GiSnowman, // Frost - Active
  GiTriorb,
  GiMoonOrbit,
  GiBrain,
} from "react-icons/gi";
...
export const magicSchools: Record<
  MagicSchool,
  {
    name: string;
    color: string;
...
> = {
  arcane: {
    ...
    icon: RiMagicFill,
    description:
      "Fundamental magic focusing on raw magical energy and special effects",
  },
  storm: {
    name: "Storm",
    color: "#eab308",
...
export const activeSkills: ActiveSkill[] = [
  ...
  },
  {
    name: "Magic Orb",
    description:
      "Summon a magical orb that circles around you, protecting you from enemies",
    icon: GiMoonOrbit,
    color: "#9333ea",
    cooldown: 0,
    level: process.env.NODE_ENV === "development" ? 1 : 0,
  ...
  },
  {
    name: "Blizzard",
    description:
      "Summon a blizzard that continuously damages and slows enemies",
    icon: GiSnowman,
    color: "#60a5fa",
    cooldown: 15,
    duration: 6,
